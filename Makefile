...
# Phase 3 Sprint 1: notification dispatcher. Only linked into wt-roomd; agents
...
test-autonomy: all
	./tests/integration/wt-autonomy.sh
...
test-remote-execution: all
	./tests/integration/wt-remote-execution.sh
...
test-initiative-report: all
	./tests/integration/wt-initiative-report.sh
